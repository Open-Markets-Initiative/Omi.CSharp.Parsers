...
namespace Nyse.AmexOptions.BinaryGateway
{
    ...
    {
        /// <summary>
        ///  Size of Clearing Firm Covered underlying field in bytes
        /// </summary>
        public const int Size = 5;

        /// <summary>
        ///  Length of Clearing Firm Covered field
        /// </summary>
        public int Length
        {
        ...
        /// <summary>
        ///  Clearing Firm Covered value
        /// </summary>
        public readonly string Value
            => Decode(this);

        /// <summary>
        ///  Does Clearing Firm Covered field contain a value?
        /// </summary>
        ...
        /// <summary>
        ///  Read Clearing Firm Covered
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static string Decode(ClearingFirmCovered value)
            => new string((sbyte*)value.Bytes, 0, value.Length);

        /// <summary>
        ///  Try Read Clearing Firm Covered
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
