...
namespace Nyse.AmexOptions.BinaryGateway
{
    ...
    public unsafe struct PreLiquidityIndicator
    {
        ...
        /// <summary>
        ///  Length of Pre Liquidity Indicator field
        /// </summary>
        public int Length
        {
        ...
        /// <summary>
        ///  Pre Liquidity Indicator value
        /// </summary>
        public readonly string Value
            => Decode(this);

        /// <summary>
        ///  Does Pre Liquidity Indicator field contain a value?
        /// </summary>
        ...
        /// <summary>
        ///  Read Pre Liquidity Indicator
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static string Decode(PreLiquidityIndicator value)
            => new string((sbyte*)value.Bytes, 0, value.Length);

        /// <summary>
        ///  Try Read Pre Liquidity Indicator
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
