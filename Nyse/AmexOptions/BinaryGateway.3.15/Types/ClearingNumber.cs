...
namespace Nyse.AmexOptions.BinaryGateway
{
    ...
    public unsafe struct ClearingNumber
    {
        ...
        /// <summary>
        ///  Length of Clearing Number field
        /// </summary>
        public int Length
        {
        ...
        /// <summary>
        ///  Clearing Number value
        /// </summary>
        public readonly string Value
            => Decode(this);

        /// <summary>
        ///  Does Clearing Number field contain a value?
        /// </summary>
        ...
        /// <summary>
        ///  Read Clearing Number
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static string Decode(ClearingNumber value)
            => new string((sbyte*)value.Bytes, 0, value.Length);

        /// <summary>
        ///  Try Read Clearing Number
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
