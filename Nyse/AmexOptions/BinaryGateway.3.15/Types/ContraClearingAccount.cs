...
namespace Nyse.AmexOptions.BinaryGateway
{
    ...
    public unsafe struct ContraClearingAccount
    {
        ...
        /// <summary>
        ///  Length of Contra Clearing Account field
        /// </summary>
        public int Length
        {
        ...
        /// <summary>
        ///  Contra Clearing Account value
        /// </summary>
        public readonly string Value
            => Decode(this);

        /// <summary>
        ///  Does Contra Clearing Account field contain a value?
        /// </summary>
        ...
        /// <summary>
        ///  Read Contra Clearing Account
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static string Decode(ContraClearingAccount value)
            => new string((sbyte*)value.Bytes, 0, value.Length);

        /// <summary>
        ///  Try Read Contra Clearing Account
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
