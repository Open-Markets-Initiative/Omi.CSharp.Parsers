...
public unsafe struct RelatedSymbol
{
    ...
    /// <summary>
    ///  Length of Related Symbol field
    /// </summary>
    public int Length
    {
    ...
    /// <summary>
    ///  Related Symbol value
    /// </summary>
    public readonly string Value
        => Decode(this);

    /// <summary>
    ///  Does Related Symbol field contain a value?
    /// </summary>
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static string Decode(RelatedSymbol value)
        => new string((sbyte*)value.Bytes, 0, value.Length);

    /// <summary>
    ///  Try Read Related Symbol
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
