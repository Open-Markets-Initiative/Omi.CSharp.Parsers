...
namespace Cme.Mdp3
{
    ...
    public unsafe struct CouponDayCount
    {
        ...
        /// <summary>
        ///  Length of Coupon Day Count field
        /// </summary>
        public int Length
        {
        ...
        /// <summary>
        ///  Coupon Day Count value
        /// </summary>
        public readonly string Value
            => Decode(this);

        /// <summary>
        ///  Does Coupon Day Count field contain a value?
        /// </summary>
        ...
        /// <summary>
        ///  Read Coupon Day Count
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static string Decode(CouponDayCount value)
            => new string((sbyte*)value.Bytes, 0, value.Length);

        /// <summary>
        ///  Try Read Coupon Day Count
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
