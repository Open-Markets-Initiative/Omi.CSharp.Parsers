...
namespace Cme.Mdp3
{
    ...
    public unsafe struct FxBenchmarkRateFix
    {
        ...
        /// <summary>
        ///  Length of Fx Benchmark Rate Fix field
        /// </summary>
        public int Length
        {
        ...
        /// <summary>
        ///  Fx Benchmark Rate Fix value
        /// </summary>
        public readonly string Value
            => Decode(this);

        /// <summary>
        ///  Does Fx Benchmark Rate Fix field contain a value?
        /// </summary>
        ...
        /// <summary>
        ///  Read Fx Benchmark Rate Fix
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static string Decode(FxBenchmarkRateFix value)
            => new string((sbyte*)value.Bytes, 0, value.Length);

        /// <summary>
        ///  Try Read Fx Benchmark Rate Fix
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
