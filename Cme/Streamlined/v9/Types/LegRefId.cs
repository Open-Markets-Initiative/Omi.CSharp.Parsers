...
/// <summary>
///  Leg Ref Id: Used to correlate leg instrument definitions with their executions. Cross referenced to Tag 1788
/// </summary>

public unsafe struct LegRefId
{
    /// <summary>
    ///  Fix Tag for Leg Ref Id
    /// </summary>
    public const ushort FixTag = 654;

    /// <summary>
    ///  Size of Leg Ref Id underlying field in bytes
    /// </summary>
    public const int Size = 17;

    /// <summary>
    ///  Length of Leg Ref Id field
    /// </summary>
    public int Length
    {
    ...
    /// <summary>
    ///  Does Leg Ref Id field contain a value?
    /// </summary>
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static string Decode(LegRefId value)
