...
{
    /// <summary>
    ///  Leg Security Type: Identifies the type of instrument.
    /// </summary>
    public unsafe struct LegSecurityType
    {
        ...
        /// <summary>
        ///  Size of Leg Security Type underlying field in bytes
        /// </summary>
        public const int Size = 8;

        /// <summary>
        ///  Length of Leg Security Type field
        /// </summary>
        public int Length
        {
        ...
        /// <summary>
        ///  Leg Security Type value
        /// </summary>
        public readonly string Value
            => Decode(this);

        /// <summary>
        ///  Does Leg Security Type field contain a value?
        /// </summary>
        ...
        /// <summary>
        ///  Read Leg Security Type
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static string Decode(LegSecurityType value)
            => new string((sbyte*)value.Bytes, 0, value.Length);

        /// <summary>
        ///  Try Read Leg Security Type
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
