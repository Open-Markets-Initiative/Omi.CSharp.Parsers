...
{
    /// <summary>
    ///  Leg Symbol: For Eris Interest rate swaps values would be FIXED, FLOAT and for Spread, value would be underline instrument
    /// </summary>
    public unsafe struct LegSymbol
    {
        ...
        /// <summary>
        ///  Size of Leg Symbol underlying field in bytes
        /// </summary>
        public const int Size = 50;

        /// <summary>
        ///  Length of Leg Symbol field
        /// </summary>
        public int Length
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static string Decode(LegSymbol value)
