...
{
    /// <summary>
    ///  Market Sector: Identifies the market in which a product trades. For e.g. CDS, Dairy
    /// </summary>
    public unsafe struct MarketSector
    {
        /// <summary>
        ///  Fix Tag for Market Sector
        /// </summary>
        public const ushort FixTag = 37521;

        /// <summary>
        ///  Size of Market Sector underlying field in bytes
        /// </summary>
        public const int Size = 26;

        /// <summary>
        ///  Length of Market Sector field
        /// </summary>
        public int Length
        {
        ...
        /// <summary>
        ///  Does Market Sector field contain a value?
        /// </summary>
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static string Decode(MarketSector value)
            => new string((sbyte*)value.Bytes, 0, value.Length);

        /// <summary>
        ///  Try Read Market Sector
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
