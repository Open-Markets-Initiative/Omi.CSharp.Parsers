...
/// <summary>
///  Strategy Link Id: Identifies the multileg strategy (e.g. spread) to which the trade belongs. This links together trade legs executed as part of a strategy during a single match event.
/// </summary>
...
public unsafe struct StrategyLinkId
{
    ...
    /// <summary>
    ///  Size of Strategy Link Id underlying field in bytes
    /// </summary>
    public const int Size = 26;

    /// <summary>
    ///  Length of Strategy Link Id field
    /// </summary>
    public int Length
    {
    ...
    /// <summary>
    ///  Strategy Link Id value
    /// </summary>
    public readonly string Value
        => Decode(this);

    /// <summary>
    ///  Does Strategy Link Id field contain a value?
    /// </summary>
    ...
    /// <summary>
    ///  Read Strategy Link Id
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static string Decode(StrategyLinkId value)
        => new string((sbyte*)value.Bytes, 0, value.Length);

    /// <summary>
    ///  Try Read Strategy Link Id
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
