...
{
    /// <summary>
    ///  Product Complex: Identifies an entire suite of products for a given market.
    /// </summary>
    public unsafe struct ProductComplex
    {
        ...
        /// <summary>
        ///  Size of Product Complex underlying field in bytes
        /// </summary>
        public const int Size = 26;

        /// <summary>
        ///  Length of Product Complex field
        /// </summary>
        public int Length
        {
        ...
        /// <summary>
        ///  Product Complex value
        /// </summary>
        public readonly string Value
            => Decode(this);

        /// <summary>
        ///  Does Product Complex field contain a value?
        /// </summary>
        ...
        /// <summary>
        ///  Read Product Complex
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static string Decode(ProductComplex value)
            => new string((sbyte*)value.Bytes, 0, value.Length);

        /// <summary>
        ///  Try Read Product Complex
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
