...
/// <summary>
///  Sector Sub Group: A further qualification of Sector Group For e.g. North American
/// </summary>

public unsafe struct SectorSubGroup
{
    /// <summary>
    ///  Fix Tag for Sector Sub Group
    /// </summary>
    public const ushort FixTag = 37523;

    /// <summary>
    ///  Size of Sector Sub Group underlying field in bytes
    /// </summary>
    public const int Size = 26;

    /// <summary>
    ///  Length of Sector Sub Group field
    /// </summary>
    public int Length
    {
    ...
    /// <summary>
    ///  Sector Sub Group value
    /// </summary>
    public readonly string Value
        => Decode(this);

    /// <summary>
    ///  Does Sector Sub Group field contain a value?
    /// </summary>
    ...
    /// <summary>
    ///  Read Sector Sub Group
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static string Decode(SectorSubGroup value)
        => new string((sbyte*)value.Bytes, 0, value.Length);

    /// <summary>
    ///  Try Read Sector Sub Group
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
