...
{
    /// <summary>
    ///  Md Entry Id: Market data entry identifier to map multiple prices of a single trade
    /// </summary>
    public unsafe struct MdEntryId
    {
        /// <summary>
        ///  Fix Tag for Md Entry Id
        /// </summary>
        public const ushort FixTag = 278;

        /// <summary>
        ///  Size of Md Entry Id underlying field in bytes
        /// </summary>
        public const int Size = 26;

        /// <summary>
        ///  Length of Md Entry Id field
        /// </summary>
        public int Length
        {
        ...
        /// <summary>
        ///  Does Md Entry Id field contain a value?
        /// </summary>
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static string Decode(MdEntryId value)
            => new string((sbyte*)value.Bytes, 0, value.Length);

        /// <summary>
        ///  Try Read Md Entry Id
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
