...
/// <summary>
///  Yield Type: Type of yield
/// </summary>

public unsafe struct YieldType
{
    /// <summary>
    ///  Fix Tag for Yield Type
    /// </summary>
    public const ushort FixTag = 235;

    /// <summary>
    ///  Size of Yield Type underlying field in bytes
    /// </summary>
    public const int Size = 8;

    /// <summary>
    ///  Length of Yield Type field
    /// </summary>
    public int Length
    {
    ...
    /// <summary>
    ///  Does Yield Type field contain a value?
    /// </summary>
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static string Decode(YieldType value)
