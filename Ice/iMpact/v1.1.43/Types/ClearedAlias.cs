...
{
    /// <summary>
    ///  Size of Cleared Alias underlying field in bytes
    /// </summary>
    public const int Size = 15;

    /// <summary>
    ///  Length of Cleared Alias field
    /// </summary>
    public int Length
    {
    ...
    /// <summary>
    ///  Does Cleared Alias field contain a value?
    /// </summary>
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static string Decode(ClearedAlias value)
        => new string((sbyte*)value.Bytes, 0, value.Length);

    /// <summary>
    ///  Try Read Cleared Alias
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
