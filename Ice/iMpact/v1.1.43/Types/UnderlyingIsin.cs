...
namespace Ice.iMpact
{
    ...
    {
        /// <summary>
        ///  Size of Underlying Isin underlying field in bytes
        /// </summary>
        public const int Size = 12;

        /// <summary>
        ///  Length of Underlying Isin field
        /// </summary>
        public int Length
        {
        ...
        /// <summary>
        ///  Underlying Isin value
        /// </summary>
        public readonly string Value
            => Decode(this);

        /// <summary>
        ///  Does Underlying Isin field contain a value?
        /// </summary>
        ...
        /// <summary>
        ///  Read Underlying Isin
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static string Decode(UnderlyingIsin value)
            => new string((sbyte*)value.Bytes, 0, value.Length);

        /// <summary>
        ///  Try Read Underlying Isin
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
