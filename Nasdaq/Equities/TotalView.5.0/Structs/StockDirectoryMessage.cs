...
public partial class StockDirectoryMessage
{
    ...
    /// </summary>
    public MarketCategory MarketCategory => Layout.MarketCategory.Value;
    ...
    /// </summary>
    public FinancialStatusIndicator FinancialStatusIndicator => Layout.FinancialStatusIndicator.Value;

    /// <summary>
    ///  Denotes the number of shares that represent a round lot for the issue
    /// </summary>
    public uint RoundLotSize => Layout.RoundLotSize.Value;

    /// <summary>
    ///  Indicates if NASDAQ system limits order entry for issue
    /// </summary>
    public RoundLotsOnly RoundLotsOnly => Layout.RoundLotsOnly.Value;

    /// <summary>
    ///  Identifies the security class for the issue as assigned by NASDAQ. See Appendix for allowable values.
    /// </summary>
    public IssueClassification IssueClassification => Layout.IssueClassification.Value;

    /// <summary>
    ///  Identifies the security sub-type for the issue as assigned by NASDAQ. See Appendix for allowable values.
    /// </summary>
    public string IssueSubType => Layout.IssueSubType.Value;
    ...
    /// </summary>
    public Authenticity Authenticity => Layout.Authenticity.Value;

    /// <summary>
    ///  Indicates if a security is subject to mandatory close-out of short sales under SEC Rule 203(b)(3).
    /// </summary>
    public ShortSaleThresholdIndicator ShortSaleThresholdIndicator => Layout.ShortSaleThresholdIndicator.Value;
    ...
    /// </summary>
    public IpoFlag IpoFlag => Layout.IpoFlag.Value;

    /// <summary>
    ///  Indicates which Limit Up / Limit Down price band calculation parameter is to be used for the instrument.
    /// </summary>
    public LuldReferencePriceTier LuldReferencePriceTier => Layout.LuldReferencePriceTier.Value;

    /// <summary>
    ///  Indicates whether the security is an exchange traded product (ETP):
    /// </summary>
    public EtpFlag EtpFlag => Layout.EtpFlag.Value;
    ...
    /// </summary>
    public uint EtpLeverageFactor => Layout.EtpLeverageFactor.Value;
    ...
    /// </summary>
    public InverseIndicator InverseIndicator => Layout.InverseIndicator.Value;
