...
public partial class IpoQuotingPeriodUpdate
{
    ...
    /// </summary>
    public uint IpoQuotationReleaseTime => Fields.IpoQuotationReleaseTime.Value;
    ...
    /// </summary>
    public IpoQuotationReleaseQualifier IpoQuotationReleaseQualifier => Fields.IpoQuotationReleaseQualifier.Value;
    ...
    /// </summary>
    public uint IpoPrice => Fields.IpoPrice.Value;
